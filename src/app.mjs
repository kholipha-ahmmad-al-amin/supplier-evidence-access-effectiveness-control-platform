...
export const createApp = (service) => {
  ...
  app.post('/access-effectiveness-control-reviews', (request, response, next) => {
    try {
  ...
  app.get('/access-effectiveness-control-reviews/:id', (request, response, next) => {
    try {
  ...
  app.post('/access-effectiveness-control-reviews/:id/:action', (request, response, next) => {
    try {
